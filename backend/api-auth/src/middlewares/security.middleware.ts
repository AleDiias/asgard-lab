...
/** Limite próprio do login (não partilhar contador com forgot/reset). */
export const loginRateLimiter = rateLimit({
  ...
  message: {
    success: false,
    error: { message: "Muitas tentativas de login. Aguarde alguns minutos e tente novamente." },
  },
});

/** Pedidos de e-mail de recuperação (abuse). */
export const forgotPasswordRateLimiter = rateLimit({
  ...
  message: {
    success: false,
    error: { message: "Muitos pedidos de recuperação. Tente novamente mais tarde." },
  },
});

/** Submissão do novo token + senha (tentativas com token inválido). */
export const resetPasswordRateLimiter = rateLimit({
  ...
  message: {
    success: false,
    error: { message: "Muitas tentativas de redefinição. Aguarde alguns minutos e tente novamente." },
  },
});

/** @deprecated Usar `loginRateLimiter` / `forgotPasswordRateLimiter` / `resetPasswordRateLimiter`. */
