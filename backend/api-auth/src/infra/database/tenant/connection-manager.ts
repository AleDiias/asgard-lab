...
/**
 * Nome físico do banco PostgreSQL do tenant (ex.: `tenant_acme_localhost`).
 * O slug `dbName` gravado no Master (`tenants.db_name`) não inclui o prefixo `tenant_`.
 */
...
/**
 * Retorna instância Drizzle para o banco do tenant, com cache de Pool + Drizzle.
 * @param databaseName Nome do database PostgreSQL (ex.: `tenant_demo`).
 */
